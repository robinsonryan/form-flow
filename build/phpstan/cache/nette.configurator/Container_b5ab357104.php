...
class Container_b5ab357104 extends _PHPStan_3729594d8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0362(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b5ab357104 $container)
			{
	...
	public function createServiceContainer(): Container_b5ab357104
	{
		return $this;
	}
