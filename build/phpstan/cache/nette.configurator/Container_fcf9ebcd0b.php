...
// source: phar:///var/www/html/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon
...
class Container_fcf9ebcd0b extends _PHPStan_3729594d8\Nette\DI\Container
{
	protected $tags = [
	...
	protected $types = ['container' => '_PHPStan_3729594d8\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_3729594d8\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'096',
				'097',
	...
	public function createService04(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			['analyseAndScan' => ['/var/www/html/src/FormFlowServiceProvider.php'], 'analyse' => []]
		);
	}
	...
	public function createService0345(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			['phar:///var/www/html/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon', '/var/www/html/phpstan.neon'],
			$this->getParameter('analysedPaths'),
			['/var/www/html'],
			$this->getParameter('analysedPathsFromConfig'),
			'8',
	...
	public function createService0362(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_fcf9ebcd0b $container)
			{
	...
	{
		return new Larastan\Larastan\Properties\MigrationCache('/var/www/html/build/phpstan', false);
	}
	...
	public function createServiceContainer(): Container_fcf9ebcd0b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => ['analyseAndScan' => ['/var/www/html/src/FormFlowServiceProvider.php'], 'analyse' => []],
			'level' => 8,
			...
			'env' => [
				'VIRTUAL_HOST' => 'form-flow.ddev.site',
				...
				'USER' => 'robinsonryan',
				'LANGUAGE' => 'C',
				'HOSTNAME' => 'form-flow-web',
				'DDEV_SITENAME' => 'form-flow',
				'HOME' => '/home/robinsonryan',
				'HTTP_EXPOSE' => '80:80,8025:8025',
				'DDEV_PRIMARY_URL_WITHOUT_PORT' => 'https://form-flow.ddev.site',
				'PGDATABASE' => 'db',
				...
				'PHP_IDE_CONFIG' => 'serverName=form-flow.ddev.site',
				...
				'NVM_DIR' => '/home/robinsonryan/.nvm',
				'COMPOSER_BINARY' => '/usr/local/bin/composer',
				'COREPACK_ENABLE_DOWNLOAD_PROMPT' => '0',
				'DDEV_HOSTNAME' => 'form-flow.ddev.site',
				'SHELL_VERBOSITY' => '0',
				...
				'TERM' => 'xterm',
				'DDEV_PROJECT' => 'form-flow',
				'COREPACK_HOME' => '/mnt/ddev-global-cache/corepack',
				'DDEV_PRIMARY_URL' => 'https://form-flow.ddev.site',
				...
				'MYSQL_HISTFILE' => '/mnt/ddev-global-cache/mysqlhistory/form-flow-web/mysql_history',
